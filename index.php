...
<body>
  ...
  <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
    <div class="container">
      <a class="navbar-brand" href="#">jual hewan</a>
  ...
  <section id="hero" class="text-center p-5 bg-info-subtle text-sm-start">
    <div class="container">
      <div class="d-sm-flex flex-sm-row-reverse align-items-center">
        <img src="https://akcdn.detik.net.id/community/media/visual/2023/11/20/ayam-bangkok.png?w=700&amp;q=90"
        ...
        <div>
          ...
          <h4 class="lead display-6">
            Menjual semua hewan langka di dunia yang ada tanpa terkecuali
          </h4>
          <h6>
...
<!-- article end -->
      ...
      <div id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="https://mmc.tirto.id/image/otf/970x0/2020/02/21/istock-1064585820_ratio-16x9.jpg"
              class="d-block w-100" alt="..." />
          </div>
          <div class="carousel-item">
            <img src="https://www.putraperkasa.co.id/wp-content/uploads/2023/07/Ayam-Leghorn-Pict-01-1024x576.webp"
              class="d-block w-100" alt="..." />
          </div>
          <div class="carousel-item">
            <img
          ...
          <div class="carousel-item">
            <img src="https://upload.wikimedia.org/wikipedia/commons/5/5b/Eublepharis_macularius1.jpg"
              class="d-block w-100" alt="..." />
          </div>
          <div class="carousel-item">
            <img src="https://assets.ohbegitu.com/crop/740x416/data/photo/2023/11/18/6558bf52ccb63.png"
              class="d-block w-100" alt="..." />
          </div>
        </div>
  ...
  <section id="schedule" class="text-center p-5">
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center">
        <div class="col">
          <div class="card h-100">
            <div class="card-header bg-info text-white">SENIN</div>
        ...
        <div class="col">
          <div class="card h-100">
            <div class="card-header bg-info text-white">SELASA</div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
        ...
        <div class="col">
          <div class="card h-100">
            <div class="card-header bg-info text-white">RABU</div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
        ...
        <div class="col">
          <div class="card h-100">
            <div class="card-header bg-info text-white">KAMIS</div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
        ...
        <div class="col">
          <div class="card h-100">
            <div class="card-header bg-info text-white">SABTU</div>
            <ul class="list-group list-group-flush">
  ...
  <section id="aboutme" class="text-center p-5 bg-info-subtle">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-center">
        <div class="p-3">
          <img src="https://sangsabda.wordpress.com/wp-content/uploads/2012/05/jesuse6_top.jpg" class="rounded-circle border shadow" width="300" />
        </div>
        <div class="p-md-5 text-sm-start">
          <h3 class="lead">A11.2023.14913</h3>
          <h1 class="fw-bold">Faidzul Umam</h1>
  ...
  <footer id="footer" class="text-center p-5">
    <div>
      <a href="https://www.instagram.com/f_mammm"><i class="bi bi-instagram h2 p-2 text-danger"></i></a>
      <a href="https://twitter.com/AsuTxc"><i class="bi bi-twitter h2 p-2"></i></a>
      <a href="https://wa.me/+6281228782538"><i class="bi bi-whatsapp h2 p-2 text-success"></i></a>
    </div>
    <div>Faidzul Umam &copy; 2024</div>
  </footer>
  <!-- footer end -->
